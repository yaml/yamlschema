...
- name: norm-canonicalizes-single-ref-allof
  ...
  want: |
    {"$schema":"https:\/\/json-schema.org\/draft\/2020-12\/schema","type":"object","$defs":{"base":{"type":"object"}},"properties":{"inherited":{"type":"object","$ref":"#\/$defs\/base","properties":{"local":{"type":"integer"}}},"rich":{"allOf":[{"title":"Branch","$ref":"#\/$defs\/base"}]}}}
...
- name: norm-warns-for-float-export
  ...
  want: |
    ...
    {"$schema":"https:\/\/json-schema.org\/draft\/2020-12\/schema","type":"object","additionalProperties":false,"required":["precise"],"properties":{"precise":{"type":"number"}}}
